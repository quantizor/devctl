...
struct AppInstancePolicyTests {
    ...
    @Test func aSecondCopyAtTheSamePathStandsDown() {
        let incumbent = instance("/Applications/directa.app", 100, 60)
        let newcomer = instance("/Applications/directa.app", 200, 1)
    ...
    @Test func theDMGHandoffKeepsBothCopies() {
        let volume = instance("/Volumes/directa/directa.app", 100, 60)
        let applications = instance("/Applications/directa.app", 200, 1)
    ...
    @Test func aCopyIsNotItsOwnTwin() {
        let only = instance("/Applications/directa.app", 100, 60)
    ...
    @Test func aTieIsBrokenSoExactlyOneLeaves() {
        let first = instance("/Applications/directa.app", 100, 5)
        let second = instance("/Applications/directa.app", 200, 5)
    ...
    @Test func aMissingLaunchDateStillDecides() {
        let dated = instance("/Applications/directa.app", 300, 5)
        let undated = instance("/Applications/directa.app", 100, nil)
        ...
        let neither = [instance("/Applications/directa.app", 100, nil),
                       instance("/Applications/directa.app", 200, nil)]
    ...
    @Test func onlyTheOldestOfSeveralStays() {
        let running = [
            instance("/Applications/directa.app", 100, 30),
            instance("/Applications/directa.app", 200, 20),
            instance("/Applications/directa.app", 300, 10),
        ]
