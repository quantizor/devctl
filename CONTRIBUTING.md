...
A harness that only supports plain-text injection needs no adapter code at all: point its hook at `devctl context`. Shipped adapters today: `antigravity`, `claude`, `cursor`.
