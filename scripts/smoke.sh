...
TAL="$(/usr/libexec/PlistBuddy -c 'Print :NSSupportsAutomaticTermination' "$ROOT/devctl.app/Contents/Info.plist")"
[[ "$TAL" == "false" ]] || fail "assembled Info.plist NSSupportsAutomaticTermination was '$TAL'"
SUDDEN="$(/usr/libexec/PlistBuddy -c 'Print :NSSupportsSuddenTermination' "$ROOT/devctl.app/Contents/Info.plist")"
